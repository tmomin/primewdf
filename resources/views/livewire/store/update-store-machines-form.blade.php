<div>
    {{-- @if (Gate::check('addTeamMember', $team)) --}}
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addMachine">
                <x-slot name="title">
                    {{ __('Add Machine') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Add a new machine to the store') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Please provide the machine name you would like to use.') }}
                        </div>
                    </div>

                    <!-- Store Name -->
                    <div class="col-span-6 sm:col-span-3">
                        <x-jet-input id="machine_id" type="hidden" wire:model.defer="addMachineForm.id" />
                        <x-jet-label for="machine_name" value="{{ __('Machine Name') }}" />
                        <x-jet-input id="machine_name" type="text" class="mt-1 block w-full" wire:model.defer="addMachineForm.name" />
                        <x-jet-input-error for="machine_name" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
